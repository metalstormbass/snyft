...
var categoryTooltips = map[string]string{
	...
	"Install Execution": "Checks: presence of install-time script hooks (preinstall, install, postinstall for npm; setup.py for PyPI; pom.xml for Maven), and dangerous pattern analysis in scripts from cloned repos (network requests, filesystem modifications, binary execution, credential exfiltration).",
